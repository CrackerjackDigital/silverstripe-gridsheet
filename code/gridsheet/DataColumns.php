<?php
/**
 * Copy of GridFieldDataColumns but extends Object to allow extension mechanism and config to work.
 *
 * @package forms
 * @subpackage fields-gridfield
 */
class GridSheetDataColumns extends Object implements GridField_ColumnProvider {
